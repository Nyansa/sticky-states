...
import { PathUtils, PathNode, UIRouterPluginBase, TransitionHookPhase, TransitionHookScope, find, tail, isString, isArray, inArray, removeFrom, pushTo, identity, anyTrueR, assertMap, uniqR, defaultTransOpts } from "@uirouter/core";
...
var StickyStatesPlugin = (function (_super) {
    ...
    StickyStatesPlugin.prototype._calculateStickyTreeChanges = function (trans) {
        ...
        var applyToParams = function (retainedNode, toPath, idx) {
        ...
        if (shouldRewritePaths) {
            ...
            // Rewrite the to path
            var retainedWithToParams = tc.retained.map(function (retainedNode, idx) { return applyToParams(retainedNode, tc.to, idx); });
